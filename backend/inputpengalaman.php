...
<html>
    ...
    if (isset($_POST['Simpan']))
    {
        ...
        mysqli_query($conn, "insert into pengalaman values ('$pengalamanID', '$pengalamanJUDUL', '$pengalamanSUB', '$pengalamanKET', '$pengalamanVID', '$namafoto')");
    ...
    <body>
        ...
        <!-- membuat form input data kategori -->
         ...
         <div class="row mb-3 mt-5">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="pengalamanID" name="inputID" placeholder="ID Pengalaman">
            </div>
         </div>
         <div class="row mb-3 mt-5">
         ...
         <div class="row mb-3 mt-5">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="pengalamanSUB" name="inputSUB" placeholder="Sub Judul Pengalaman">
            </div>
         </div>
         <div class="row mb-3 mt-5">
            <label for="pengalamanKET" class="col-sm-2 col-form-label">Keterangan Pengalaman</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="pengalamanKET" name="inputKET" placeholder="Ketarangan Pengalaman">
            </div>
         </div>
         <div class="row mb-3 mt-5">
            <label for="pengalamanVID" class="col-sm-2 col-form-label">Link Vid Pengalaman</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="pengalamanVID" name="inputVID" placeholder="Link Vid Pengalaman">
            </div>
         </div>
