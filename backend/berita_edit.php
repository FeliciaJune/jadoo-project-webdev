...
<html>
    ...
    if (isset($_POST['ubah']))
    {
        ...
        if($namafoto == ""){
        mysqli_query($conn, "UPDATE berita SET berita_JUDUL='$beritaJUDUL', berita_ISI='$beritaISI', berita_SUMBER='$beritaSUMBER', 
        kategori_ID='$kategoriKODE' WHERE berita_ID='$kodeberita'");
        } else
        {
        mysqli_query($conn, "UPDATE berita SET berita_JUDUL='$beritaJUDUL', berita_ISI='$beritaISI', berita_SUMBER='$beritaSUMBER', 
        kategori_ID='$kategoriKODE', berita_FOTO='$namafoto' WHERE berita_ID='$kodeberita'");
        }
    ...
    <body>
        ...
        <!-- membuat form input data kategori -->
         ...
         <div class="row mb-3 mt-5">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="beritaISI" name="inputISI" value="<?php echo $row_edit["berita_ISI"]?>">
            </div>
         </div>
         <div class="row mb-3 mt-5">
