...
<html>
    ...
    if (isset($_POST['Simpan']))
    {
        ...
        mysqli_query($conn, "insert into kecamatan values ('$kecamatanID', '$kecamatanNAMA', '$kabupatenID', '$namafoto')");
    ...
    <body>
        ...
        <!-- membuat form input data kategori -->
         ...
         <div class="row mb-3 mt-5">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="kecamatanID" name="inputID" placeholder="Kode Kecamatan">
            </div>
         </div>
         <div class="row mb-3 mt-5">
