...
<html>
    ...
    if (isset($_POST['ubah']))
    {
        ...
        if($namafoto == ""){
        mysqli_query($conn, "UPDATE kategori SET kategori_NAMA='$kategoriNAMA', kategori_KET='$kategoriKET'
        WHERE kategori_ID='$kategoriID'");
        } else
        {
        mysqli_query($conn, "UPDATE kategori SET kategori_NAMA='$kategoriNAMA', kategori_KET='$kategoriKET',
        kategori_FOTO='$namafoto' WHERE  kategori_ID='$kategoriID'");
        }
    ...
    <body>
        ...
        <!-- membuat form input data kategori -->
         ...
         <div class="row mb-3 mt-5">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="kategoriKET" name="inputKET" value="<?php echo $row_edit["kategori_KET"]?>">
            </div>
         </div>
