...
<html>
    ...
    if (isset($_POST['Simpan']))
    {
        ...
        mysqli_query($conn, "insert into testimoni values ('$testiID', '$testiJUDUL', '$testiISI', '$testiNAMA', '$testiKotaNeg', '$namafoto')");
    ...
    <body>
        ...
        <!-- membuat form input data kategori -->
         ...
         <div class="row mb-3 mt-5">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="testiID" name="inputID" placeholder="ID Testimoni">
            </div>
         </div>
         <div class="row mb-3 mt-5">
            <label for="testiJUDUL" class="col-sm-2 col-form-label">Judul Testimoni</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="testiJUDUL" name="inputJUDUL" placeholder="Judul Testimoni">
            </div>
         </div>
         <div class="row mb-3 mt-5">
            <label for="testiISI" class="col-sm-2 col-form-label">Isi Testimoni</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="testiISI" name="inputISI" placeholder="Isi Testimoni">
            </div>
         </div>
         <div class="row mb-3 mt-5">
            <label for="testiNAMA" class="col-sm-2 col-form-label">Nama Testimoni</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="testiNAMA" name="inputNAMA" placeholder="Nama Testimoni">
            </div>
         </div>
         <div class="row mb-3 mt-5">
            <label for="testiKotaNeg" class="col-sm-2 col-form-label">Kota-Negara Testimoni</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="testiKotaNeg" name="inputKotaNeg" placeholder="Kota-Negara Testimoni">
            </div>
         </div>
