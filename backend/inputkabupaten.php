...
<html>
    ...
    if (isset($_POST['Simpan']))
    {
        ...
        mysqli_query($conn, "insert into kabupaten values ('$kabupatenID', '$kabupatenNAMA', '$provinsiID', '$kabupatenALAMAT', '$namafoto')");
    ...
    <body>
        ...
        <!-- membuat form input data kategori -->
         ...
         <div class="row mb-3 mt-5">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="kabupatenID" name="inputID" placeholder="Kode Kabupaten">
            </div>
         </div>
         <div class="row mb-3 mt-5">
