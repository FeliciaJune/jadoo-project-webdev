...
<body class="sb-nav-fixed">
    ...
    $edit = mysqli_query($conn, "SELECT * FROM kabupaten WHERE kabupaten_ID = '$kodekabupaten'");
    ...
    if (isset($_POST['ubah']))
    {
        ...
        if($namafoto == ""){
        mysqli_query($conn, "UPDATE kabupaten set kabupaten_NAMA='$kabupatenNAMA', provinsi_ID='$provinsiID', kabupaten_ALAMAT='$kabupatenALAMAT'
        WHERE kabupaten_ID='$kodekabupaten'"); 
        } else
        {
        mysqli_query($conn, "UPDATE kabupaten set kabupaten_NAMA='$kabupatenNAMA', provinsi_ID='$provinsiID', kabupaten_ALAMAT='$kabupatenALAMAT',
        kabupaten_FOTO='$namafoto' WHERE kabupaten_ID='$kodekabupaten'");
        }
        header("location: inputkabupaten.php");
    }
    /** $query = mysqli_query ($conn, "select * from kabupaten,provinsi */
    /** where kabupaten.provinsi_ID = provinsi.provinsi_ID"); */
    ...
    <body>
        ...
        <div class="col-10">
        <div class="judul">    
        <h2 style="padding-left:40px;">Input Kabupaten<h2>
        </div>
        <div class="judul2">    
        <small style="padding-left:40px;">Kabupaten</small>
        </div>
        <!-- membuat form input data kategori -->
         ...
         <div class="row mb-3 mt-5">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="kabupatenID" name="inputID" value="<?php echo $row_edit["kabupaten_ID"]?>"readonly>
            </div>
         </div>
         <div class="row mb-3 mt-5">
         ...
         <div class="row mb-3 mt-5">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="kabupatenALAMAT" name="inputALAMAT" value="<?php echo $row_edit["kabupaten_ALAMAT"]?>">
            </div>
         </div>
         ...
         <div class="judul3">
            <h2 style="padding-left:40px;">Output Kabupaten<h2>
         </div>
         ...
         <form method="POST">
            <div class="form-group row mt-5">
                ...
                <div class="col-sm-6">
                    ...
                    {echo $_POST["search"];}?>" placeholder="Cari Kabupaten">
                </div>
         ...
         <table class="table table-striped table-success table-hover mt-5">
            ...
            if(isset($_POST["kirim"]))
            {
              $search = $_POST["search"];
              $query = mysqli_query ($conn, "select * from kabupaten, provinsi
              where kabupaten.provinsi_ID = provinsi.provinsi_ID and 
              kabupaten_NAMA like '%".$search."%'");
            }else
            {
              $query = mysqli_query ($conn, "select * from kabupaten, provinsi
              where kabupaten.provinsi_ID = provinsi.provinsi_ID");
            ...
            <tr class="danger">
                ...
                <td>
                    <?php if($row['kabupaten_FOTO']==""){ echo "<img src='images/noimage.png'
                    width='88'/>";}else{?>
                    <img src="../admin/images/<?php echo $row['kabupaten_FOTO'] ?>" width="88" class="
                    img-responsive" />
                <?php }?>
                </td>
                <td>
                   <a href="kabupaten_edit.php?ubahkabupaten=<?php echo $row["kabupaten_ID"]?>" class="btn btn-success btn-sm" title="EDIT">
                ...
                <td>
                   <a href="kabupaten_hapus.php?hapuskabupaten=<?php echo $row["kabupaten_ID"]?>" class="btn btn-danger btn-sm" title="HAPUS">
