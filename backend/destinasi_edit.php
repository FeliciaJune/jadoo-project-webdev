...
<html>
    ...
    $edit = mysqli_query($conn, "SELECT * FROM destinasi WHERE destinasi_ID = '$kodedestinasi' ");
    ...
    if (isset($_POST['ubah']))
    {
        ...
        if($namafoto == ""){
        mysqli_query($conn, "UPDATE destinasi set kategori_ID='$kategoriID', kabupaten_ID='$kabupatenID', destinasi_NAMA='$destinasiNAMA', destinasi_ALAMAT='$destinasiALAMAT', 
        destinasi_TRIP='$destinasiTRIP', destinasi_IDR='$destinasiIDR' WHERE destinasi_ID='$kodedestinasi'");
        } else
        {
        mysqli_query($conn, "UPDATE destinasi set kategori_ID='$kategoriID', kabupaten_ID='$kabupatenID', destinasi_NAMA='$destinasiNAMA', destinasi_ALAMAT='$destinasiALAMAT', 
        destinasi_FOTO='$namafoto', destinasi_TRIP='$destinasiTRIP', destinasi_IDR='$destinasiIDR' WHERE destinasi_ID='$kodedestinasi'");
        }
    ...
    <body>
        ...
        <small style="padding-left:40px;">Destinasi Wisata</small>
         ...
         <div class="row mb-3 mt-5">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="destinasiID" name="inputID" value="<?php echo $row_edit["destinasi_ID"]?>" readonly>
            </div>
         </div>
        ...
        <div class="row mb-3 mt-5">
         ...
         <div class="row mb-3 mt-5">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="destinasiTRIP" name="inputTRIP" value="<?php echo $row_edit["destinasi_TRIP"]?>">
            </div>
         </div>
         ...
         <div class="row mb-3 mt-5">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="destinasiIDR" name="inputIDR" value="<?php echo $row_edit["destinasi_IDR"]?>">
            </div>
         </div>    
