...
<html>
    ...
    if (isset($_POST['Simpan']))
    {
        ...
        mysqli_query($conn, "insert into provinsi values ('$provinsiID', '$provinsiNAMA', '$namafoto')");
    ...
    <body>
        ...
        <!-- membuat form input data kategori -->
         ...
         <div class="row mb-3 mt-5">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="provinsiID" name="inputID" placeholder="Kode Provinsi">
            </div>
         </div>
         <div class="row mb-3 mt-5">
         ...
         <table class="table table-striped table-success table-hover mt-5">
            ...
            if(isset($_POST["kirim"]))
            {
              $search = $_POST["search"];
              $query = mysqli_query ($conn, "select * from provinsi
              WHERE provinsi_NAMA like '%".$search."%'");
            }else
            {
              $query = mysqli_query ($conn, "select * from provinsi");
            } 
